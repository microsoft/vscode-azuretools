...
import { AzExtTreeItem, AzureWizard, DialogResponses, IActionContext, IAzureQuickPickItem, IParsedError, openInPortal, parseError } from 'vscode-azureextensionui';
...
async function showGitHubAuthPrompt(node: AzExtTreeItem, client: SiteClient, context: IActionContext): Promise<void> {
