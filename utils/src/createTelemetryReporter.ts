...
import { TelemetryEventProperties, TelemetryReporter } from '@vscode/extension-telemetry';
...
export interface IInternalTelemetryReporter {
    sendTelemetryErrorEvent(eventName: string, properties?: TelemetryEventProperties, measurements?: { [key: string]: number | undefined }): void;
}
