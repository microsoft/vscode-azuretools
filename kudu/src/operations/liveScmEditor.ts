...
import * as Mappers from "../models/liveScmEditorMappers";
import * as Parameters from "../models/parameters";
import { KuduClientContext } from "../kuduClientContext";

/** Class representing a LiveScmEditor. */
export class LiveScmEditor {
  private readonly client: KuduClientContext;

  /**
   * Create a LiveScmEditor.
   ...
   * @param path
   * @param [options] The optional parameters
   * @returns Promise<Models.LiveScmEditorPutItemResponse>
   */
  putItem(file: msRest.HttpRequestBody, path: string, options?: msRest.RequestOptionsBase): Promise<Models.LiveScmEditorPutItemResponse>;
  /**
   * @param file
   * @param path
   * @param callback The callback
  ...
  putItem(file: msRest.HttpRequestBody, path: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.LiveScmEditorPutItemResponse> {
    return this.client.sendOperationRequest(
      {
        file,
        path,
      ...
      callback) as Promise<Models.LiveScmEditorPutItemResponse>;
  }

  /**
   * @param path
   * @param [options] The optional parameters
   * @returns Promise<Models.LiveScmEditorDeleteItemResponse>
   */
  deleteItem(path: string, options?: Models.LiveScmEditorDeleteItemOptionalParams): Promise<Models.LiveScmEditorDeleteItemResponse>;
  /**
   * @param path
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  deleteItem(path: string, options: Models.LiveScmEditorDeleteItemOptionalParams, callback: msRest.ServiceCallback<any>): void;
  deleteItem(path: string, options?: Models.LiveScmEditorDeleteItemOptionalParams | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.LiveScmEditorDeleteItemResponse> {
    return this.client.sendOperationRequest(
      {
        path,
        options
      ...
      callback) as Promise<Models.LiveScmEditorDeleteItemResponse>;
  }
   ...
   * @param path
   * @param [options] The optional parameters
   * @returns Promise<Models.LiveScmEditorPutItem1Response>
   */
  putItem1(file: msRest.HttpRequestBody, path: string, options?: msRest.RequestOptionsBase): Promise<Models.LiveScmEditorPutItem1Response>;
  /**
   * @param file
   * @param path
   * @param callback The callback
  ...
  putItem1(file: msRest.HttpRequestBody, path: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.LiveScmEditorPutItem1Response> {
    return this.client.sendOperationRequest(
      {
        file,
        path,
      ...
      callback) as Promise<Models.LiveScmEditorPutItem1Response>;
  }

  /**
   * @param path
   * @param [options] The optional parameters
   * @returns Promise<Models.LiveScmEditorDeleteItem1Response>
   */
  deleteItem1(path: string, options?: Models.LiveScmEditorDeleteItem1OptionalParams): Promise<Models.LiveScmEditorDeleteItem1Response>;
  /**
   * @param path
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  deleteItem1(path: string, options: Models.LiveScmEditorDeleteItem1OptionalParams, callback: msRest.ServiceCallback<any>): void;
  deleteItem1(path: string, options?: Models.LiveScmEditorDeleteItem1OptionalParams | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.LiveScmEditorDeleteItem1Response> {
    return this.client.sendOperationRequest(
      {
        path,
        options
      ...
      callback) as Promise<Models.LiveScmEditorDeleteItem1Response>;
  }
