...
import { type IAuthenticationWWWAuthenticateRequest, isAuthenticationWWWAuthenticateRequest } from "./utils/isAuthenticationWWWAuthenticateRequest";
 ...
 */
function formScopesArg(scopes?: string | string[] | IAuthenticationWWWAuthenticateRequest, tenantId?: string): string[] | IAuthenticationWWWAuthenticateRequest {
 ...
 * Use `IAuthenticationWWWAuthenticateRequest` if you need to pass in a challenge (WWW-Authenticate header). Note: Use of `IAuthenticationWWWAuthenticateRequest` requires VS Code 1.104 or newer.
 ...
 */
export async function getSessionFromVSCode(scopes?: string | string[] | IAuthenticationWWWAuthenticateRequest, tenantId?: string, options?: vscode.AuthenticationGetSessionOptions): Promise<vscode.AuthenticationSession | undefined> {
