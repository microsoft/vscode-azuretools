...
export declare class ResourceGroupCreateStep<T extends IResourceGroupWizardContext> extends AzureWizardStepWithActivityOutput<T> {
    /**
     * 100
     */
    public priority: number;
