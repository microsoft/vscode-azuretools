        ...
        for (const account of cosmosAccounts) {
            ...
            if (experience && experience.api === "MongoDB") {
                ...
                const databaseItem: DBTreeItem = {
                    ...
                    port: postgresDefaultPort, connectionString,
                    azureData: {
                        accountId: accountId,
                ...
                const databaseItem: DBTreeItem = { hostName: accountName, port: postgresDefaultPort, connectionString, azureData: { accountId: accountId, accountName: accountName, resourceGroup: azureUtils.azureUtils.getResourceGroupFromId(accountId), accountKind: getExperienceLabel(account) }, docDBData: { masterKey, documentEndpoint: endpoint } };
                databaseTreeItems.push(databaseItem);
            }
